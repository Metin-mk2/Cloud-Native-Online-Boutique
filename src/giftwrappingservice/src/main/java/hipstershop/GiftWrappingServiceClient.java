...
public class GiftWrappingServiceClient {

  private static final Logger logger = LogManager.getLogger(GiftWrappingServiceClient.class);
  ...
  private GiftWrappingServiceClient(String host, int port) {
    this(
  ...
  private GiftWrappingServiceClient(ManagedChannel channel) {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    GiftWrappingServiceClient client = new GiftWrappingServiceClient(host, serverPort);
    try {
